...
function (_React$PureComponent) {
  ...
  function QRCodeCanvas() {
    ...
    _defineProperty(_assertThisInitialized$1(_this), "_canvas", void 0);

    _defineProperty(_assertThisInitialized$1(_this), "_image", void 0);

    _defineProperty(_assertThisInitialized$1(_this), "state", {
      imgLoaded: false
    });

    _defineProperty(_assertThisInitialized$1(_this), "handleImageLoad", function () {
      _this.setState({
        imgLoaded: true
      });
    });
  ...
  _createClass(QRCodeCanvas, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement("canvas", _extends$1({
        style: canvasStyle,
        height: size,
        width: size,
