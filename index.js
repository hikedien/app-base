...
var ShareWithFriends = function ShareWithFriends() {
  ...
  React.useEffect(function () {
    var options = {
      text: shareUrl,
      colorDark: '#106D5A',
      correctLevel: easy_qrcode_min.CorrectLevel.H,
    ...
    new easy_qrcode_min(qrCode.current, options);
  }, []);
